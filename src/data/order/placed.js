...
module.exports = ({ originOrderId, merchantId, origin }) => ({
  ...
  payload: {
    ...
    details: {
        ...
        items: [
          {
            ...
            quantity: 2,
            description:
              "Dados complementares sobre o produto fornecidos pelo estabelecimento",
      ...
      delivery: {
        deliveryDateTime:
          "String - Data e hora da entrega do pedido, formato ISO 8601",
        deliveredBy: "ORIGIN",
        address: {
          formattedAddress: "PEDIDO DE TESTE - NÃO ENTREGAR - Ramal Bujari, 10",
          country: "BR",
